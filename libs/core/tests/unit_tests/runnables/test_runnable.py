...
def test_lambda_schemas(snapshot: SnapshotAssertion) -> None:
    ...
    def get_value(value):  # type: ignore[no-untyped-def]
    ...
    async def aget_value(value):  # type: ignore[no-untyped-def]
    ...
    async def aget_values(value):  # type: ignore[no-untyped-def]
        return {
